...
*********************************************************************************************************
*/
void delay_ms(uint32_t _ulDelayTime)//void bsp_DelayMS(uint32_t _ulDelayTime)
{
	delay_us(1000*_ulDelayTime); // bsp_DelayUS(1000*_ulDelayTime);
}
...
*********************************************************************************************************
*/
void delay_us(uint32_t _ulDelayTime) //void bsp_DelayUS(uint32_t _ulDelayTime) 
{
    uint32_t i;
	for(i=0; i<20; i++);	
}
