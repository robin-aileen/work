...
#endif
{
    ...
    if ( TIM_GetITStatus(TIM_HARD , TIM_IT_Update) != RESET ) 
	{	
...
//		 if( timer_sen_scan ) timer_sen_scan--;
//		 if( timer_sen_timeout ) timer_sen_timeout--;
//		 if( timer_utc_timeout ) timer_utc_timeout--;
//		 if( timer_usr ) timer_usr--;
	}	
}
