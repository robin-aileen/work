...
/* 按键口对应的RCC时钟 */
#define RCC_ALL_KEY 	(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC )//| RCC_APB2Periph_GPIOD | RCC_APB2Periph_GPIOG)
...
//DET_PEDAL
#define GPIO_PORT_K9    GPIOB
#define GPIO_PIN_K9	    GPIO_Pin_13
//DET_ZERO
#define GPIO_PORT_K10 	GPIOB
#define GPIO_PIN_K10	GPIO_Pin_14
//DET_SYRINGE
#define GPIO_PORT_K11 	GPIOB
#define GPIO_PIN_K11 	GPIO_Pin_15
...
// //DET_ZERO
// #define GPIO_PORT_K8    GPIOB
// #define GPIO_PIN_K8	    GPIO_Pin_14
// //DET_SYRINGE
// #define GPIO_PORT_K9    GPIOB
// #define GPIO_PIN_K9     GPIO_Pin_15
...
static void bsp_InitKeyHard(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_PIN_K10;
	GPIO_Init(GPIO_PORT_K10, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = GPIO_PIN_K11;
	GPIO_Init(GPIO_PORT_K11, &GPIO_InitStructure);
}
...
static void bsp_InitKeyVar(void)
{
	...
	{
		s_tBtn[i].LongTime = 0;//KEY_LONG_TIME;			/* 长按时间 0 表示不检测长按键事件 */
