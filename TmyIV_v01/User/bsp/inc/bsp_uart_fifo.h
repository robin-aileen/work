...
/* 定义串口波特率和FIFO缓冲区大小，分为发送缓冲区和接收缓冲区, 支持全双工 */
...
#if UART2_FIFO_EN == 1
	#define UART2_BAUD			19200 //115200
	...
	#define UART4_TX_BUF_SIZE	1*128
...
uint16_t comGetLen(COM_PORT_E _ucPort);//新加入
uint8_t comGetALine(COM_PORT_E _ucPort, uint8_t *TEM);
